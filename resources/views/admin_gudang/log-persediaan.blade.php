                    ...
                    <table id="table_persediaan" class="table table-bordered table-striped dataTable dtr-inline"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="sorting" tabindex="0" aria-controls="table_persediaan" rowspan="1"
                                    colspan="1">Penggunaan
                                </th>

                                <th class="sorting" tabindex="0" aria-controls="table_persediaan" rowspan="1"
                                    colspan="1">Penggunaan Rata-Rata
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="table_persediaan" rowspan="1"
                                    colspan="1">Biaya Penyimpanan
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="table_persediaan" rowspan="1"
                                    colspan="1">Biaya Pemesanan
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="table_persediaan" rowspan="1"
                                    colspan="1">Aksi</th>
                            </tr>
            ...
            <form id="form-add-persediaan">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="pembelian" id="pembelian"
                            placeholder="Pembelian" min="0">
                    </div>
